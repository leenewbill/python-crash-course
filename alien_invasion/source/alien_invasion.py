...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        #   Easy button: red button below and left of Play button.
        self.easy_button = Button(self, "Easy", (255, 255, 0), 
                (self.play_button.width * -2, self.play_button.height * 2))
